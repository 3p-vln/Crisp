 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(bf(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function bf(n){const e=n.getComponent();return e?.type==="VERSION"}const ss="@firebase/app",Jo="0.9.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=new Map,as=new Map;function tp(n,e){try{n.container.addComponent(e)}catch(t){St.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ct(n){const e=n.name;if(as.has(e))return St.debug(`There were multiple attempts to register component ${e}.`),!1;as.set(e,n);for(const t of ki.values())tp(t,n);return!0}function Qi(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt=Zf;function Bs(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:os,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw lt.create("bad-app-name",{appName:String(r)});if(t||(t=Ol()),!t)throw lt.create("no-options");const s=ki.get(r);if(s){if(Pi(t,s.options)&&Pi(i,s.config))return s;throw lt.create("duplicate-app",{appName:r})}const o=new hf(r);for(const l of as.values())o.addComponent(l);const a=new ip(t,i,o);return ki.set(r,a),a}function $s(n=os){const e=ki.get(n);if(!e&&n===os&&Ol())return Bs();if(!e)throw lt.create("no-app",{appName:n});return e}function Le(n,e,t){var i;let r=(i=ep[n])!==null&&i!==void 0?i:n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),St.warn(a.join(" "));return}Ct(new ct(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dp(n){Ct(new ct("platform-logger",e=>new Rf(e),"PRIVATE")),Ct(new ct("heartbeat",e=>new cp(e),"PRIVATE")),Le(ss,Jo,n),Le(ss,Jo,"esm2017"),Le("fire-js","")}dp("");var fp="firebase",pp="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di=new Fs("@firebase/auth");function gp(n,...e){Di.logLevel<=$.WARN&&Di.warn(`Auth (${Dt}): ${n}`,...e)}function _i(n,...e){Di.logLevel<=$.ERROR&&Di.error(`Auth (${Dt}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ke(n,...e){throw qs(n,...e)}function Ve(n,...e){return qs(n,...e)}function _p(n,e,t){const i=Object.assign(Object.assign({},mp()),{[e]:t});return new Ln("auth","Firebase",i).create(e,{appName:n.name})}function qs(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return $l.create(n,...e)}function N(n,e,...t){if(!n)throw qs(e,...t)}function je(n){const e="INTERNAL ASSERTION FAILED: "+n;throw _i(e),new Error(e)}function Qe(n,e){n||je(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ls(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function yp(){return na()==="http:"||na()==="https:"}function na(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Rp(n,e=!1){const t=ft(n),i=await t.getIdToken(e),r=Gs(i);N(r&&r.exp&&r.auth_time&&r.iat,t.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,o=s?.sign_in_provider;return{claims:r,token:i,authTime:mn(Fr(r.auth_time)),issuedAtTime:mn(Fr(r.iat)),expirationTime:mn(Fr(r.exp)),signInProvider:o||null,signInSecondFactor:s?.sign_in_second_factor||null}}function Fr(n){return Number(n)*1e3}function Gs(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return _i("JWT malformed, contained fewer than 3 sections"),null;try{const r=kl(t);return r?JSON.parse(r):(_i("Failed to decode base64 JWT payload"),null)}catch(r){return _i("Caught error parsing JWT payload as JSON",r?.toString()),null}}function bp(n){const e=Gs(n);return N(e,"internal-error"),N(typeof e.exp<"u","internal-error"),N(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zp(n,e,t=!1){const{auth:i}=n,r="reauthenticate";try{const s=await wn(n,lc(i,r,e,n),t);N(s.idToken,i,"internal-error");const o=Gs(s.idToken);N(o,i,"internal-error");const{sub:a}=o;return N(n.uid===a,i,"user-mismatch"),Ht._forOperation(n,r,s)}catch(s){throw s?.code==="auth/user-not-found"&&Ke(i,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ks extends oc{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Ut(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Ut(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Ut(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Tm(n){return em(n.auth,new Ks(n),n.bypassAuthState)}function Em(n){const{auth:e,user:t}=n;return N(t,e,"internal-error"),Zp(t,new Ks(n),n.bypassAuthState)}async function wm(n){const{auth:e,user:t}=n;return N(t,e,"internal-error"),Jp(t,new Ks(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt=new Fs("@firebase/firestore");function Ma(){return bt.logLevel}function b(n,...e){if(bt.logLevel<=$.DEBUG){const t=e.map(yo);bt.debug(`Firestore (${nn}): ${n}`,...t)}}function Ye(n,...e){if(bt.logLevel<=$.ERROR){const t=e.map(yo);bt.error(`Firestore (${nn}): ${n}`,...t)}}function Kt(n,...e){if(bt.logLevel<=$.WARN){const t=e.map(yo);bt.warn(`Firestore (${nn}): ${n}`,...t)}}function yo(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vo(n){if(n.code!==A.FAILED_PRECONDITION||n.message!==N_)throw n;b("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class To{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=i=>this.oe(i),this._e=i=>t.writeSequenceNumber(i))}oe(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this._e&&this._e(e),e}}To.ae=-1;function mr(n){return n==null}function ws(n){return n===0&&1/n==-1/0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eo(n){var e,t;return((t=(((e=n?.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function wo(n){const e=n.mapValue.fields.__previous_value__;return Eo(e)?wo(e):e}function On(n){const e=ht(n.mapValue.fields.__local_write_time__.timestampValue);return new Ee(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X_{constructor(e,t=null,i=[],r=[],s=null,o=null,a=null){this.path=e,this.collectionGroup=t,this.orderBy=i,this.filters=r,this.limit=s,this.startAt=o,this.endAt=a,this.he=null}}function za(n,e=null,t=[],i=[],r=null,s=null,o=null){return new X_(n,e,t,i,r,s,o)}function Ao(n){const e=z(n);if(e.he===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(i=>Ss(i)).join(","),t+="|ob:",t+=e.orderBy.map(i=>function(s){return s.field.canonicalString()+s.dir}(i)).join(","),mr(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(i=>Yt(i)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(i=>Yt(i)).join(",")),e.he=t}return e.he}function So(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!$_(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Cu(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!$a(n.startAt,e.startAt)&&$a(n.endAt,e.endAt)}function Cs(n){return O.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ly(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ws(e)?"-0":e}}function cy(n){return{integerValue:""+n}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(){this._=void 0}}function uy(n,e,t){return n instanceof Ps?function(r,s){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return s&&Eo(s)&&(s=wo(s)),s&&(o.fields.__previous_value__=s),{mapValue:o}}(t,e):n instanceof ji?Mu(n,e):n instanceof Gi?Nu(n,e):function(r,s){const o=dy(r,s),a=ja(o)+ja(r.Te);return As(o)&&As(r.Te)?cy(a):ly(r.serializer,a)}(n,e)}function hy(n,e,t){return n instanceof ji?Mu(n,e):n instanceof Gi?Nu(n,e):t}function dy(n,e){return n instanceof ks?function(i){return As(i)||function(s){return!!s&&"doubleValue"in s}(i)}(e)?e:{integerValue:0}:null}class Ps extends Tr{}class ji extends Tr{constructor(e){super(),this.elements=e}}function Mu(n,e){const t=Lu(e);for(const i of n.elements)t.some(r=>Ue(r,i))||t.push(i);return{arrayValue:{values:t}}}class Gi extends Tr{constructor(e){super(),this.elements=e}}function Nu(n,e){let t=Lu(e);for(const i of n.elements)t=t.filter(r=>!Ue(r,i));return{arrayValue:{values:t}}}class ks extends Tr{constructor(e,t){super(),this.serializer=e,this.Te=t}}function ja(n){return ee(n.integerValue||n.doubleValue)}function Lu(n){return Io(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function fy(n,e){return n.field.isEqual(e.field)&&function(i,r){return i instanceof ji&&r instanceof ji||i instanceof Gi&&r instanceof Gi?Qt(i.elements,r.elements,Ue):i instanceof ks&&r instanceof ks?Ue(i.Te,r.Te):i instanceof Ps&&r instanceof Ps}(n.transform,e.transform)}class At{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new At}static exists(e){return new At(void 0,e)}static updateTime(e){return new At(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ei(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Co{}function Vu(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new my(n.key,At.none()):new Ro(n.key,n.data,At.none());{const t=n.data,i=xe.empty();let r=new me(Te.comparator);for(let s of e.fields)if(!r.has(s)){let o=t.field(s);o===null&&s.length>1&&(s=s.popLast(),o=t.field(s)),o===null?i.delete(s):i.set(s,o),r=r.add(s)}return new Er(n.key,i,new st(r.toArray()),At.none())}}function py(n,e,t){n instanceof Ro?function(r,s,o){const a=r.value.clone(),l=Ha(r.fieldTransforms,s,o.transformResults);a.setAll(l),s.convertToFoundDocument(o.version,a).setHasCommittedMutations()}(n,e,t):n instanceof Er?function(r,s,o){if(!Ei(r.precondition,s))return void s.convertToUnknownDocument(o.version);const a=Ha(r.fieldTransforms,s,o.transformResults),l=s.data;l.setAll(Fu(r)),l.setAll(a),s.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(n,e,t):function(r,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function Tn(n,e,t,i){return n instanceof Ro?function(s,o,a,l){if(!Ei(s.precondition,o))return a;const c=s.value.clone(),u=Wa(s.fieldTransforms,l,o);return c.setAll(u),o.convertToFoundDocument(o.version,c).setHasLocalMutations(),null}(n,e,t,i):n instanceof Er?function(s,o,a,l){if(!Ei(s.precondition,o))return a;const c=Wa(s.fieldTransforms,l,o),u=o.data;return u.setAll(Fu(s)),u.setAll(c),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),a===null?null:a.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(h=>h.field))}(n,e,t,i):function(s,o,a){return Ei(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):a}(n,e,t)}function Ga(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(i,r){return i===void 0&&r===void 0||!(!i||!r)&&Qt(i,r,(s,o)=>fy(s,o))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Ro extends Co{constructor(e,t,i,r=[]){super(),this.key=e,this.value=t,this.precondition=i,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class Er extends Co{constructor(e,t,i,r,s=[]){super(),this.key=e,this.data=t,this.fieldMask=i,this.precondition=r,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Fu(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const i=n.data.field(t);e.set(t,i)}}),e}function Ha(n,e,t){const i=new Map;ne(n.length===t.length);for(let r=0;r<t.length;r++){const s=n[r],o=s.transform,a=e.data.field(s.field);i.set(s.field,hy(o,a,t[r]))}return i}function Wa(n,e,t){const i=new Map;for(const r of n){const s=r.transform,o=t.data.field(r.field);i.set(r.field,uy(s,o,e))}return i}class my extends Co{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo{constructor(){this.onExistenceFilterMismatchCallbacks=new Map}static get instance(){return di}static getOrCreateInstance(){return di===null&&(di=new bo),di}onExistenceFilterMismatch(e){const t=Symbol();return this.onExistenceFilterMismatchCallbacks.set(t,e),()=>this.onExistenceFilterMismatchCallbacks.delete(t)}notifyOnExistenceFilterMismatch(e){this.onExistenceFilterMismatchCallbacks.forEach(t=>t(e))}}let di=null;/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fy{constructor(e){this.ct=e}}function Uy(n){const e=Oy({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Rs(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(e,t,i,r){this.targetId=e,this.fromCache=t,this.Li=i,this.ki=r}static qi(e,t){let i=B(),r=B();for(const s of t.docChanges)switch(s.type){case 0:i=i.add(s.doc.key);break;case 1:r=r.add(s.doc.key)}return new xo(e,t.fromCache,i,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zy{constructor(){this.Qi=!1}initialize(e,t){this.Ki=e,this.indexManager=t,this.Qi=!0}getDocumentsMatchingQuery(e,t,i,r){return this.$i(e,t).next(s=>s||this.Ui(e,t,r,i)).next(s=>s||this.Wi(e,t))}$i(e,t){if(qa(t))return E.resolve(null);let i=Je(t);return this.indexManager.getIndexType(e,i).next(r=>r===0?null:(t.limit!==null&&r===1&&(t=Rs(t,null,"F"),i=Je(t)),this.indexManager.getDocumentsMatchingTarget(e,i).next(s=>{const o=B(...s);return this.Ki.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,i).next(l=>{const c=this.Gi(t,a);return this.zi(t,c,o,l.readTime)?this.$i(e,Rs(t,null,"F")):this.ji(e,c,t,l)}))})))}Ui(e,t,i,r){return qa(t)||r.isEqual(L.min())?this.Wi(e,t):this.Ki.getDocuments(e,i).next(s=>{const o=this.Gi(t,s);return this.zi(t,o,i,r)?this.Wi(e,t):(Ma()<=$.DEBUG&&b("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),bs(t)),this.ji(e,o,t,x_(r,-1)))})}Gi(e,t){let i=new me(Du(e));return t.forEach((r,s)=>{vr(e,s)&&(i=i.add(s))}),i}zi(e,t,i,r){if(e.limit===null)return!1;if(i.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(r)>0)}Wi(e,t){return Ma()<=$.DEBUG&&b("QueryEngine","Using full collection scan to execute query:",bs(t)),this.Ki.getDocumentsMatchingQuery(e,t,ut.min())}ji(e,t,i,r){return this.Ki.getDocumentsMatchingQuery(e,i,r).next(s=>(t.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+o.stack),a}(i);throw Ye("INTERNAL UNHANDLED ERROR: ",r),i}).then(i=>(this.Ja=!1,i))));return this.Wa=t,t}enqueueAfterDelay(e,t,i){this.eu(),this.Za.indexOf(e)>-1&&(t=0);const r=Lo.createAndSchedule(this,e,t,i,s=>this.ru(s));return this.ja.push(r),r}eu(){this.Ha&&V()}verifyOperationInProgress(){}async iu(){let e;do e=this.Wa,await e;while(e!==this.Wa)}su(e){for(const t of this.ja)if(t.timerId===e)return!0;return!1}ou(e){return this.iu().then(()=>{this.ja.sort((t,i)=>t.targetTimeMs-i.targetTimeMs);for(const t of this.ja)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.iu()})}_u(e){this.Za.push(e)}ru(e){const t=this.ja.indexOf(e);this.ja.splice(t,1)}}class lh extends Uo{constructor(e,t,i,r){super(e,t,i,r),this.type="firestore",this._queue=function(){return new Jv}(),this._persistenceKey=r?.name||"[DEFAULT]"}_terminate(){return this._firestoreClient||ch(this),this._firestoreClient.terminate()}}function Zv(n,e){const t=typeof n=="object"?n:$s(),i=typeof n=="string"?n:e||"(default)",r=Qi(t,"firestore").getImmediate({identifier:i});if(!r._initialized){const s=xl("firestore");s&&Xv(r,...s)}return r}function eT(n){return n._firestoreClient||ch(n),n._firestoreClient.verifyNotTerminated(),n._firestoreClient}function ch(n){var e,t,i;const r=n._freezeSettings(),s=function(a,l,c,u){return new U_(a,l,c,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,ah(u.experimentalLongPollingOptions),u.useFetchStreams)}(n._databaseId,((e=n._app)===null||e===void 0?void 0:e.options.appId)||"",n._persistenceKey,r);n._firestoreClient=new $v(n._authCredentials,n._appCheckCredentials,n._queue,s),!((t=r.localCache)===null||t===void 0)&&t._offlineComponentProvider&&(!((i=r.localCache)===null||i===void 0)&&i._onlineComponentProvider)&&(n._firestoreClient._uninitializedComponentsProvider={_offlineKind:r.localCache.kind,_offline:r.localCache._offlineComponentProvider,_online:r.localCache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mh="storage";function VT(n=$s(),e){n=ft(n);const i=Qi(n,mh).getImmediate({identifier:e}),r=xl("storage");return r&&FT(i,...r),i}function FT(n,e,t,i={}){NT(n,e,t,i)}function UT(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),r=n.getProvider("app-check-internal");return new LT(t,i,r,e,Dt)}function BT(){Ct(new ct(mh,UT,"PUBLIC").setMultipleInstances(!0)),Le(_l,yl,""),Le(_l,yl,"esm2017")}BT();const gh={apiKey:"AIzaSyAOmgmjB_k7AzapNtXEBcxT53BvR_WbCyw",authDomain:"crisp-b06bf.firebaseapp.com",projectId:"crisp-b06bf",storageBucket:"crisp-b06bf.appspot.com",messagingSenderId:"712604544303",appId:"1:712604544303:web:52821ca807fa74e2da85da",measurementId:"G-6MTNM6EBKH"},Bo=Bs(gh);Bs(gh,"Secondary");pg(Bo);const $T=Zv(Bo);VT(Bo);async function zT(n){return await hT(Yv($T,n))}async function qT(n,e){n.forEach(i=>{e(i)})}we.use([Vd,Fd,Ud]);const vl=un(".summer-sale__swiper-wrapper");class jT{swiper;slidesArr;constructor(){this.swiper=new we(".summer-sale__swiper",{slidesPerView:2,autoplay:{delay:3e3},grabCursor:!0,pagination:{el:".swiper-pagination"},navigation:{nextEl:".swiper-btn-next",prevEl:".swiper-btn-prew"}}),this.slidesArr=[],this.loadCards()}async loadCards(){qT(await zT("main-swiper"),e=>this.slidesArr.push(e.data())),console.log(this.slidesArr),this.renderSldes()}renderSldes(){this.slidesArr.forEach(e=>{vl&&vl.insertAdjacentHTML("beforeend",`
          ...
          `)})}}document.addEventListener("DOMContentLoaded",async function(){new _h,new yh,new jT});
