 ...
 */const mh="storage";function VT(n=zs(),e){n=ft(n);const i=Qi(n,mh).getImmediate({identifier:e}),r=xl("storage");return r&&FT(i,...r),i}function FT(n,e,t,i={}){NT(n,e,t,i)}function UT(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),r=n.getProvider("app-check-internal");return new LT(t,i,r,e,Dt)}function BT(){Ct(new ct(mh,UT,"PUBLIC").setMultipleInstances(!0)),Le(_l,yl,""),Le(_l,yl,"esm2017")}BT();const gh={apiKey:"AIzaSyAOmgmjB_k7AzapNtXEBcxT53BvR_WbCyw",authDomain:"crisp-b06bf.firebaseapp.com",projectId:"crisp-b06bf",storageBucket:"crisp-b06bf.appspot.com",messagingSenderId:"712604544303",appId:"1:712604544303:web:52821ca807fa74e2da85da",measurementId:"G-6MTNM6EBKH"},$o=$s(gh);$s(gh,"Secondary");pg($o);const $T=Zv($o);VT($o);async function zT(n){return await hT(Yv($T,n))}async function qT(n,e){n.forEach(i=>{e(i)})}we.use([Vd,Fd,Ud]);const vl=un(".summer-sale__swiper-wrapper");class jT{swiper;slidesArr;constructor(){this.swiper=new we(".summer-sale__swiper",{slidesPerView:2,autoplay:{delay:1e4},grabCursor:!0,pagination:{el:".swiper-pagination"},navigation:{nextEl:".swiper-btn-next",prevEl:".swiper-btn-prew"}}),this.slidesArr=[],this.loadCards()}async loadCards(){qT(await zT("main-swiper"),e=>this.slidesArr.push(e.data())),console.log(this.slidesArr),this.renderSldes()}renderSldes(){this.slidesArr.forEach(e=>{vl&&vl.insertAdjacentHTML("beforeend",`
          ...
          `)})}}class GT{static stop(){const e=new Event("loadingIsFinished");document.dispatchEvent(e)}}class HT{allSkeleton;constructor(){this.allSkeleton=es(".skeleton"),this.removeSkeleton()}removeSkeleton(){Promise.all(Array.from(document.images).filter(e=>!e.complete).map(e=>new Promise(t=>{e.onload=e.onerror=t}))).then(()=>{this.allSkeleton.forEach(e=>{e.classList.remove("skeleton")})})}}document.addEventListener("DOMContentLoaded",async()=>{new _h,new yh,new jT,GT.stop()});document.addEventListener("loadingIsFinished",()=>{new HT});
